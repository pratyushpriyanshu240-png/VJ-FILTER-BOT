...
API_ID = int(environ.get('23623514', ''))
API_HASH = environ.get('891cd1ba488b7e1bc10e3e4a38b69412', '')
BOT_TOKEN = environ.get('8308049497:AAFp50Iy8nSjjew3vtQtdRY5Wtf5rgXGTT4', "")
...
# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('7446571529', '').split()] # For Multiple Id Use One Space Between Each.
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('7446571529', '').split()]  # For Multiple Id Use One Space Between Each.
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/suppor8282')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/truvola')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/suppor8282') # Support Chat Link Without https:// or @
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/YesPriyanshu0')
